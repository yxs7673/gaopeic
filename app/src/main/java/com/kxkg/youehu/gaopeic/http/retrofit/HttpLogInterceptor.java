...
import com.kxkg.youehu.gaopeic.util.WYYLog;
...
//import ajk.wyy.com.lovelife.utils.WYYLog;
...
public class HttpLogInterceptor implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        if (logHeaders) {
            if (hasRequestBody) {
                // RequestBean body headers are only present when installed as a network interceptor. Force
